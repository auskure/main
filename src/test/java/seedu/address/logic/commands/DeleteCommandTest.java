...
public class DeleteCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        DeleteCommand deleteCommand = new DeleteCommand("main", INDEX_FIRST_PERSON);
    ...
    public void execute_invalidIndexUnfilteredList_throwsCommandException() {
        ...
        DeleteCommand deleteCommand = new DeleteCommand("main", outOfBoundIndex);
    ...
    public void execute_validIndexFilteredList_success() {
        ...
        Model expectedModel = new ModelManager(model.getAddressBook(), model.getNotesList(), new UserPrefs());
        expectedModel.deletePerson(personToDelete);
        expectedModel.commitAddressBook();
    ...
    @Test
    public void equals() {
        DeleteCommand deleteFirstCommand = new DeleteCommand("main", INDEX_FIRST_PERSON);
        DeleteCommand deleteSecondCommand = new DeleteCommand("main", INDEX_SECOND_PERSON);

        // same object -> returns true
        assertTrue(deleteFirstCommand.equals(deleteFirstCommand));

        // same values -> returns true
        DeleteCommand deleteFirstCommandCopy = new DeleteCommand("main", INDEX_FIRST_PERSON);
