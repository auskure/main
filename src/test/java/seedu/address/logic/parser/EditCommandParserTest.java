...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = Integer.toString(targetIndex.getOneBased()) + PHONE_DESC_BOB
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .build();
        EditCommand expectedCommand = new EditCommand(Integer.toString(targetIndex.getOneBased()), descriptor);
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = Integer.toString(targetIndex.getOneBased()) + PHONE_DESC_BOB + EMAIL_DESC_AMY;
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        expectedCommand = new EditCommand(Integer.toString(targetIndex.getOneBased()), descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput = Integer.toString(targetIndex.getOneBased()) + INVALID_PHONE_DESC + PHONE_DESC_BOB;
