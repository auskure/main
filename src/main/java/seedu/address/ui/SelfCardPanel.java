 ...
 */
public class SelfCardPanel extends UiPart<Region> {
    ...
    public SelfCardPanel(ObservableList<Person> selfList) {
        super(FXML);
        selfList = selfList.filtered(new IsSelfPredicate());
        setConnections(selfList);
    ...
    class PersonListViewCell extends ListCell<Person> {
        ...
        protected void updateItem(Person person, boolean empty) {
            ...
            if (empty || person == null) {
                ...
                setGraphic(new SelfCard(person, getIndex() + 1).getRoot());
            }
        }
    }
