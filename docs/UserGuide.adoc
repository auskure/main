...
Want to meet up with your friends at the soonest opportunity? Or would you like to find out when is the next time you can take a break (ie no scheduled activities)? +
Use `free` which allows you to find the next available time-slot from the current time, to easily find answers to these questions!
