...
Want to meet up with your friends at the soonest opportunity? Or would you like to find out when is the next time you can take a break (ie no scheduled activities)? Use `free` to answer these questions!

Format: `free f/INDEX ...`
****
* Displays next available time slot from the current time.
* Running this command outside of the time window of 8am to 7pm, or the day window of Monday to Friday will display the next available time slot in the next weekday.
****
...
Shows the next available time slot (from current time) for my own self.
Figure 1: +
If the current day and time is Monday 3:00pm, the application will inform you that your next available time-slot is Monday 4:00pm till 8:00pm. +
If the current day and time is Monday 4:34pm, the application will inform you that your next available time-slot is Monday 4:34pm till 8:00pm.
