...
Displays a string that has contact index 1's details encoded within it. Importing the string will allow the user to see the  time-table of contact index 1 in its entirety (ie the full contents of the time-table).
