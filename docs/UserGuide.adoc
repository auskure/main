...
Users are still able to login and view available files to be downloaded. Try out `downloadSelectNotes` without the `/file` prefix!
****
...
image::chromeOpen.PNG[width="250"align="center"]
