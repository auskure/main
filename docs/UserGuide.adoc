...
i.e adding of tags and enrolled modules is not cumulative.
...
image::SampleTimeTableGYCommands.png[width="800"]
...
****
image::downloadExample.PNG[width="700"]
...
image::downloadAllSuccessful.PNG[width="700"]

_Module not found :_

image::downloadModNotFound.PNG[width="700"]

_Password or username Incorrect :_

image::downloadPasswordOrUsernameWrong.PNG[width="700"]
...
****
image::downloadSelectFileExample.PNG[width="700"]
...
image::downloadSelectFileSuccess1.PNG[width="700"]
image::downloadSelectFileSuccess2.PNG[width="700"]
...
Download a selected number of notes from IVLE, and stores them in the folder "notes".
...
image::downloadSelectExample.PNG[width="700"]
...
image::downloadSelectSuccess.PNG[width="700"]

*_File* not found :_

image::downloadSelectFileNotFound.PNG[width="700"]
...
image::showNotes1.PNG[width="700"]
image::showNotes2.PNG[width="700"]
image::showNotes3.PNG[width="700"]
