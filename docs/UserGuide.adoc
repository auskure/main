...
image::chromeOpen.png[width="900"]
...
image::fileExample.png[width="900"]
...
image::downloadSelectFileNotFound[width="900"]
...
image::showNotes1[width="900"]
image::showNotes2[width="900"]
image::showNotes3[width="900"]
