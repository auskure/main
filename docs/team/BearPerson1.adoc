...
//More description + this PPP documents contribution of the project
...
//***describe the app, and what the portfolio includes.
...
//highilights=>technical challnges.
...
//quick preface to explain ^

//for every picture, there must be a purpose of each picture.
...
//slot the pictures such that the pictures make sense
