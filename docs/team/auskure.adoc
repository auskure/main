...
** What it does: In a single command, we allow the user to delete the notes previously downloaded using
...
For the sorting algorithms, we incorporated the existing library java.util.
