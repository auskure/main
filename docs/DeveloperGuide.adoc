...
commands use _Selenium Chromedrivers_ to initiate downloads.
...
image::downloadAllNotesSequence.png[width="600",align="center"]
...
image::downloadSelectNotesSequence.png[width="600",align="center"]
