...
By: `W12-2`      Since: `Aug 2018`      Licence: `MIT`
...
* stores a `self` object that represents the user's private information
...
* can save the user's private data in xml format and read it back.
...
.  Should be able to hold up to 1000 persons without a noticeable sluggishness (i.e. lag of more than 0.5 seconds) in performance for typical usage.
